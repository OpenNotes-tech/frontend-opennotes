const LoaderSkeleton = () => {
  return (
    <div className="grid grid-cols-1 gap-y-12 pb-16 md:grid-cols-2 md:gap-x-12 md:pb-10 lg:grid-cols-3 xl:grid-cols-4">
      <div
        role="status"
        className=" animate-pulse rounded-xl border border-gray-200 p-4 shadow md:p-6"
      >
      ...
      <div
        role="status"
        className="hidden  animate-pulse rounded-xl border border-gray-200 p-4 shadow md:block md:p-6 "
      >
        <div className="mb-4 flex h-48 items-center justify-center rounded bg-gray-300 ">
          <svg
            className="h-12 w-12 text-gray-200"
      ...
      <div
        role="status"
        className="hidden  animate-pulse rounded-xl border border-gray-200 p-4 shadow md:p-6 lg:block "
      >
        <div className="mb-4 flex h-48 items-center justify-center rounded bg-gray-300 ">
          <svg
            className="h-12 w-12 text-gray-200"
      ...
      <div
        role="status"
        className="hidden  animate-pulse  rounded-xl border border-gray-200 p-4 shadow md:p-6 xl:block "
      >
        <div className="mb-4 flex h-48 items-center justify-center rounded bg-gray-300 ">
          <svg
            className="h-12 w-12 text-gray-200"
