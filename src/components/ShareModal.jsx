...
const ShareModal = () => {
  ...
  return (
    <div
      class="fixed inset-0 z-[9999] h-full w-full overflow-y-auto overflow-x-hidden bg-black bg-opacity-60 opacity-100 backdrop-blur-sm transition-opacity duration-300 p-4 text-center"
    ...
    >
      ...
      <div class="relative z-[9999] inline-block w-full text-left align-middle sm:w-auto opacity-100 scale-100">
        <div class="relative z-50 mx-auto w-full max-w-full overflow-hidden rounded-xl bg-white p-4 xs:w-[480px] sm:w-[520px] sm:p-6 lg:p-8">
          <div class="flex items-center justify-between">
            <h3 class="md:text-md font-bold text-gray-dark text-base leading-8 md:!text-xl">
              Share with
            </h3>
            <button
              type="button"
          ...
          <div class="mt-7 flex items-center justify-between">
            <div class="group text-center">
              ...
              <p class="mt-4   text-xs font-normal text-gray-dark sm:text-sm">
                Chat
              </p>
            </div>
            <div class="group text-center">
          ...
          <h3 class="md:text-h3 font-bold text-gray-dark mt-8 text-base leading-8 md:!text-xl">
            Or share with link
          </h3>
