  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative flex max-w-[60rem] flex-row rounded-xl bg-white bg-clip-border text-slate-700 shadow-md"
      >
        <button
          aria-label="Close panel"
          onClick={handleNewsModalToggle}
          className="absolute -top-3 left-[300px] z-10 inline-flex h-7 w-7 items-center justify-center rounded-full bg-white text-slate-700 transition duration-200 focus:text-slate-800 focus:shadow-md focus:outline-none md:left-[950px] md:h-8 md:w-8 lg:hover:text-slate-800 lg:hover:shadow-md"
        >
          <svg
            stroke="currentColor"
            fill="currentColor"
