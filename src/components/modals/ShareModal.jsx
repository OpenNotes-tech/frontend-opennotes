...
const ShareModal = () => {
  ...
  return (
    <AnimatePresence initial={false} onExitComplete={() => null}>
      {isShareModalOpen && (
        <motion.div
          class="fixed inset-0 z-[9999] h-full w-full overflow-y-auto overflow-x-hidden bg-black bg-opacity-60 p-4 text-center opacity-100 backdrop-blur-sm transition-opacity duration-300"
