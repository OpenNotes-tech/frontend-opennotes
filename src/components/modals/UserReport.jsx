  ...
  return (
    ...
    >
      <motion.div
        ...
        class="relative mx-auto flex w-full max-w-[45rem] flex-col rounded-xl bg-white bg-clip-border text-slate-700 shadow-md ring-1 ring-slate-900 ring-opacity-5"
      >
        <button
          aria-label="Close panel"
          onClick={handleReportModalToggle}
          class="absolute -top-4 left-[710px] z-10 inline-flex h-7 w-7 items-center justify-center rounded-full bg-white text-slate-700 transition duration-200 focus:text-slate-800 focus:shadow-md focus:outline-none md:h-8 md:w-8 lg:hover:text-slate-800 lg:hover:shadow-md"
        >
          <svg
            stroke="currentColor"
            fill="currentColor"
        ...
        <div className="flex flex-col space-y-10 p-4">
          <div className="-mb-3 mt-2 flex flex-row justify-center border-b pb-5">
            <h3
              class="capital font-serif text-base font-semibold text-slate-700 lg:text-xl"
