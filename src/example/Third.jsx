...
const Third = () => {
  return (
    <>
      <div class="rounded-md border border-blue-200 bg-blue-100 p-4 text-blue-900">
        {" "}
        <div class="flex flex-wrap justify-between">
          ...
          <div class="flex w-0 flex-1">
            ...
            <div>
              {" "}
              <h4 class="text-md font-medium leading-6">
                {" "}
              ...
              <div class="mt-3 flex">
                ...
                <button
                  type="button"
                  class="inline-flex w-full justify-center rounded-md border border-transparent bg-blue-700 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 sm:w-auto sm:text-sm"
                >
                  {" "}
                  Primary button{" "}
                </button>{" "}
                <button
                  type="button"
                  class="ml-2 inline-flex w-full justify-center rounded-md border border-transparent bg-blue-200 px-4 py-2 text-base font-medium shadow-sm hover:bg-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 sm:w-auto sm:text-sm"
                >
                  {" "}
                  Secondary button{" "}
                </button>{" "}
          ...
          <div>
            ...
            <button
              type="button"
              class="rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
              {" "}
              <svg
                width="24"
      ...
      <div class="rounded-md border border-green-200 bg-green-100 p-4 text-green-900">
        <div class="flex flex-wrap justify-between">
          <div class="flex w-0 flex-1">
            <div class="mr-3 pt-1">
              <svg
      ...
      <div class="rounded-md border border-yellow-200 bg-yellow-100 p-4 text-yellow-900">
        {" "}
        <div class="flex flex-wrap justify-between">
          {" "}
          <div class="flex w-0 flex-1">
            ...
            <div>
              ...
              <div class="mt-3 flex">
                ...
                <button
                  type="button"
                  class="inline-flex w-full justify-center rounded-md border border-transparent bg-yellow-500 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 sm:w-auto sm:text-sm"
                >
                  {" "}
                  Primary button{" "}
                </button>{" "}
                <button
                  type="button"
                  class="ml-2 inline-flex w-full justify-center rounded-md border border-transparent bg-yellow-200 px-4 py-2 text-base font-medium shadow-sm hover:bg-yellow-300 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:ring-offset-2 sm:w-auto sm:text-sm"
                >
                  {" "}
                  Secondary button{" "}
                </button>{" "}
          ...
          <div>
            ...
            <button
              type="button"
              class="rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-500"
            >
              {" "}
              <svg
                width="24"
      ...
      <div class="rounded-md border border-red-200 bg-red-100 p-4 text-red-900">
        {" "}
        <div class="flex flex-wrap justify-between">
          {" "}
          <div class="flex w-0 flex-1">
            ...
            <div>
              ...
              <div class="mt-3 flex">
                ...
                <button
                  type="button"
                  class="ml-2 inline-flex w-full justify-center rounded-md border border-transparent bg-red-200 px-4 py-2 text-base font-medium shadow-sm hover:bg-red-300 focus:outline-none focus:ring-2 focus:ring-red-400 focus:ring-offset-2 sm:w-auto sm:text-sm"
                >
                  {" "}
                  Secondary button{" "}
                </button>{" "}
          ...
          <div>
            ...
            <button
              type="button"
              class="rounded-md focus:outline-none focus:ring-2 focus:ring-red-500"
            >
              {" "}
              <svg
                width="24"
