  ...
  return (
    <div className="container px-4 lg:px-0 mx-auto">
      ...
      <section className="relative h-full lg:h-[703px]  overflow-hidden">
        <div className="hidden lg:block absolute right-0 bottom-0 h-full w-full lg:w-4/12">
          <img
          ...
          <div className="max-w-5xl mx-auto">
            <div className="flex flex-wrap -mx-4 py-5">
              <div className="w-full lg:w-2/5 px-4 mb-8 lg:mb-0">
                ...
                <h2
                  className="mt-8 mb-12 md:mb-20 text-5xl font-bold font-heading"
                  data-config-id="header"
                >
                  Our Office in Naryn
                </h2>
                <div className="flex py-6 border-b border-gray-50">
                ...
                <div className="flex items-center py-6">
                  <span className="flex flex-shrink-0 items-center justify-center w-12 h-12 mr-8 bg-blue-500 rounded-lg">
                    <svg
                      className="w-5 h-5"
                      width="23"
                      height="23"
                  ...
                  <div>
                    <p
                      ...
                      data-config-id="val3-1"
                    >
                      Naryn, Lenin 166, KG
                    </p>
                    <p className="text-gray-300" data-config-id="val3-2">
                      The one est bad, semper six at sem quis, congue 8 AM - 8
                      PM
                    </p>
                  </div>
                </div>
              ...
              <div className="w-full lg:w-3/5 px-4">
                <div className="lg:ml-20 px-8 lg:px-12 py-6 w-full lg:max-w-md bg-white shadow-lg rounded-lg">
                  <form action="#">
                    <h3
                      className="mb-10 text-2xl font-bold font-heading"
                      data-config-id="form-header"
                    >
                      Send a message!
                    </h3>
                    <input
                      className="mb-4 w-full px-12 py-4 bg-white border font-bold placeholder-gray-900 rounded-full focus:outline-none"
                      type="email"
                      placeholder="example@jobest.live"
                    />
                    <input
                      className="mb-4 w-full px-12 py-4 bg-white border font-bold placeholder-gray-900 rounded-full focus:outline-none"
                      type="text"
                    ...
                    />
                    <textarea
                      className="w-full mb-2 px-12 py-2 bg-white border font-bold placeholder-gray-900 rounded-3xl resize-none focus:outline-none"
                      name=""
                      id=""
                      cols="30"
                      rows="4"
                    ...
                    <div className="flex mb-10">
                      <input type="checkbox" />
                      <p
                        className="pl-4 max-w-xs text-sm text-gray-300"
                    ...
                    <div className="text-right">
                      <button
                        className="py-4 px-12 text-white font-bold bg-blue-500 hover:bg-blue-600 rounded-full transition duration-200"
