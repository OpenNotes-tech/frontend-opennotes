        ...
        <div className="relative px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-[40rem] text-slate-600">
            ...
            >
              ...
              ("User", "you" or "your") may provide through the JoBest website
              (jobest.live) or in the course of purchasing any JoBest products
            ...
            <p>
              ...
              limited to your email address, which is required for you to be
            ...
            <p>
              ...
              JoBestdoes not control Paddle or its collection or use of
              information. Any questions or concerns about Paddle’s practices
              should be directed to Paddle.
            </p>
            <p>
              Paddle provides us with certain non-personal information relating
              ...
              information may be linked to the Personal Information you provide
              to us (typically limited to your email address, as stated above).
            ...
            <p>
              ...
              delete your email address, but this will prevent you from
              accessing the products you have purchased from Tailwind.
            </p>
            <p>
              When you update information, we may maintain a copy of the
              unrevised information in our records. Some information may remain
              in our private records after deletion of such information from
              your account for a retention period. Once the retention period
              expires, Personal Information shall be deleted. Therefore, the
              right to access, the right to erasure, your rights to access, add
              to, and update your information cannot be enforced after the
              expiration of the retention period.
            </p>
            <p>
              We will retain and use your information as necessary to comply
              with our legal obligations, resolve disputes, and enforce our
              agreements. We may use any aggregated data derived from or
            ...
            <p>
              ...
              any other of the following legal bases below. This, however, does
              ...
              you and/or for any pre-contractual obligations thereof; (ii)
              Processing is necessary for compliance with a legal obligation to
              which you are subject; (iv) Processing is related to a task that
              ...
              third party. In any case, we will be happy to clarify the specific
            ...
            <p>
              ...
              by email at{" "}
              <a href="mailto:support@jobest.live">support@jobest.live</a>.
            ...
            <p>
              ...
              usage and to help enforce this Policy by instructing their
            ...
            <p>
              ...
              Website. You have the ability to accept or decline cookies. Most
            ...
            <p>
              ...
              to collect and use other data about user activities on the
            ...
            <p>
              ...
              Website at any time, effective upon posting of an updated version
              of this Policy on the Website. When we do we will revise the
